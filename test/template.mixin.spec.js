...
const { TemplateMixin } = require("../index");
...
const Test = {
    actions: {
        render: {
            ...
            handler(ctx) {
                return this.render({ctx: ctx, name: ctx.params.name, data: ctx.params.data });
            }
        },
        renderEmpty: {
            handler() {
...
describe("Test template service", () => {
    ...
    describe("Test create service", () => {
        ...
        it("it should start the broker", async () => {
            ...
            test = await broker.createService(Test, Object.assign({ 
                name: "test",
                mixins: [TemplateMixin({ service: "template" })],
    ...
    describe("Test compile and render", () => {
        ...
        it("it should render the template", async () => {
            ...
            return broker.call("test.render", params, opts).then(res => {
                expect(res).toBeDefined();
        ...
        it("it should render empty string if called with empty name", async () => {
            let params = {
                name: "",
                data: { name: "my friend" }
            };
        ...
        it("it should render empty string if called without any parameters", async () => {
            let params = {
            };
            return broker.call("test.renderEmpty", params, opts).then(res => {
                expect(res).toBeDefined();
                expect(res).toEqual("");
            });
